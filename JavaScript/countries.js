...
s_a[27]="Banovići|BanjaLuka|Berkovići|Bihać|Bileća|Bijeljina|Blagaj|BosanskaDubica|BosanskaGradiška|BosanskoGrahovo|BosanskaKrupa|BosanskaKostajnica|BosanskiBrod|BosanskiNovi|BosanskiPetrovac|BosanskiŠamac|Bratunac|Brčko|Breza|Bugojno|Busovača|Bužim|Cazin|Čajniče|ČapljinaČelić|Čitluk|Čelinac|Doboj|Dobretići|Domaljevac|DonjiVakuf|Drvar|Derventa|Foča|Fojnica|Gacko|Glamoč|Gračanica|Gradačac|Grude|Goražde|GornjiVakuf|Uskoplje|Jablanica|Jajce|Kakanj|Kalesija|Kalinovik|Kiseljak|Kladanj|Ključ|Konjic|KotorVaroš|Kreševo|Kupres|Laktaši|Livno|Lukavac|Lopare|Ljubinje|Ljubuški|Maglaj|Milići|Modriča|Mostar|MrkonjićGrad|Neum|Nevesinje|NoviTravnik|Odžak|Olovo(BiH)|Orašje|Pale|Posušje|Prozor|Prača|Prijedor|Prnjavor|Ravno|Rogatica|Rudo|SanskiMost|Sapna|Sarajevo|SkenderVakuf|Sokolac|Srbac|Srebrenica|Srebrenik|Stanari|Stolac|Šipovo|ŠirokiBrijeg|Teočak|Teslić|Tešanj|Tomislavgrad|Travnik|Trebinje|Tuzla|Usora|Ustiprača|Vareš|VelikaKladuša|Visoko|Višegrad|Vitez|Vogošća|Zavidovići|Zenica|ZvornikŽepče|Živinice";
