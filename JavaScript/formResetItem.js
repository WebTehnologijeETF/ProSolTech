/**
 * Created by Edin on 5/4/2015.
 */

function formResetItem(){

    var naziv = document.getElementById('input_item_name');
    var opis=document.getElementById('input_item_description');
    var slika=document.getElementById('input_image');
    ...
    slika.style.backgroundColor ="white";
